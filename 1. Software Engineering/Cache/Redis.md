...
Then when possible, we flush it to disk with [fsync](../Linux/fsync.md) (when this runs is configurable), it will be persisted. *The downside is that the format isn't compact and uses more disk than RDB files.*
