...
*[FastAPI-template](https://github.com/s3rius/FastAPI-template) — Flexible general-purpose template for FastAPI.*
...
[Points from Documentation](Points%20from%20Documentation.md)


### Resources

1. _[Concurrency in Python with FastAPI](https://horaceguy.pages.dev/posts/python-concurrency/)_
2. *https://fastapi.tiangolo.com/tutorial/* 
3. [_5 неочевидных возможностей FastAPI: упрощаем работу с бэкендом на Python_](https://habr.com/ru/companies/first/articles/714688/)
4. [TestDriven.io FastAPI](https://testdriven.io/blog/topics/fastapi/) - Multiple FastAPI-specific articles that focus on developing and testing production-ready RESTful APIs, serving up machine learning models, and more.
	1. [_Building a CRUD App with FastAPI and MongoDB_](https://testdriven.io/blog/fastapi-mongo/)
	2. [_Asynchronous Tasks with FastAPI and Celery_](https://testdriven.io/blog/fastapi-and-celery/)
5. [FastAPI has Ruined Flask Forever for Me](https://towardsdatascience.com/fastapi-has-ruined-flask-forever-for-me-73916127da)
6. *[Why we switched from Flask to FastAPI for production machine learning](https://medium.com/@calebkaiser/why-we-switched-from-flask-to-fastapi-for-production-machine-learning-765aab9b3679) - In-depth look at why you may want to move from Flask to FastAPI.*
7. [_Почему наш стартап переехал с Flask на FastAPI_](https://habr.com/ru/company/oleg-bunin/blog/575958/)
8. [*Денис Аникин. FastAPI как основной framework для python бекендов](https://www.youtube.com/watch?v=4zjj1aHJoko) (video)*
